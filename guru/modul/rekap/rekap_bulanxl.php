...
$tglTerakhir = date('t',strtotime($tglBulan));
 ...
 <table width="100%">
 	<tr>
 		<td>
 			<img src="http://smkn1sayung.sch.id/wp-content/uploads/2020/03/logo1.png" width="130">
 		</td>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSESNSI SISWA <br>
 					<small> SMKN 1 SAYUNG</small>
 				</h1>
 				<hr>
 				<em>
				 JL.Semarang Demak KM.14 Sayung, Demak<br>, Jawa Tengah, Kode Pos (59563) <br>
 				<b>Email : smk_sayung@yahoo.com Telp.(024)6514180</b>  
 				</em>
